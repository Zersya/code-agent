...
} from './controllers/monthly-reports.js';
...
app.post('/api/monthly-reports', adminAuth, createMonthlyReport);
app.get('/api/monthly-reports', adminAuth, listMonthlyReports);
app.get('/api/monthly-reports/:month/:year', adminAuth, getMonthlyReport);
app.put('/api/monthly-reports/:id', adminAuth, updateMonthlyReport);
app.delete('/api/monthly-reports/:id', adminAuth, deleteMonthlyReport);
app.get('/api/monthly-reports/auto-generate/:month/:year', adminAuth, getAutoGeneratedData);
