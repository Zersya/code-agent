...
export const monthlyReportApi = {
  listMonthlyReports: (params: MonthlyReportListParams): Promise<ApiResponse<MonthlyReport[]>> =>
    apiClient.get<MonthlyReport[]>('/monthly-reports', params),

  getMonthlyReport: (month: number, year: number): Promise<ApiResponse<MonthlyReport>> =>
    apiClient.get<MonthlyReport>(`/monthly-reports/${month}/${year}`),

  createMonthlyReport: (data: CreateMonthlyReportRequest): Promise<ApiResponse<MonthlyReport>> =>
    apiClient.post<MonthlyReport>('/monthly-reports', data),

  updateMonthlyReport: (id: number, data: UpdateMonthlyReportRequest): Promise<ApiResponse<MonthlyReport>> =>
    apiClient.put<MonthlyReport>(`/monthly-reports/${id}`, data),

  deleteMonthlyReport: (id: number): Promise<ApiResponse<void>> =>
    apiClient.delete<void>(`/monthly-reports/${id}`),

  getAutoGeneratedData: (month: number, year: number): Promise<ApiResponse<any>> =>
    apiClient.get<any>(`/monthly-reports/auto-generate/${month}/${year}`),
}
